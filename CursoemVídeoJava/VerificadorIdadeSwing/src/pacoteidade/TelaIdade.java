...
public class TelaIdade extends javax.swing.JFrame {
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        // TODO add your handling code here:
        int ano = Integer.parseInt(txtAno.getText()); //getText equivale como .value em JS.
        int idade = 2023 - ano;
        lblIdade.setText(Integer.toString(idade)); //Pega o Inteiro e o transforma para string.
        //String sit = (idade >= 18)?"Maior de idade":"Menor de idade";
        String sit = (idade >= 16 && idade < 18 || (idade >= 65))?"É OPCIONAL":"É OBRIGATÓRIO";
