...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        ...
        //Pego o valor da txtN1 e o transforma em número inteiro através do parseInt
        int n2 = Integer.parseInt(txtN2.getText());
        //Pega o valor da txtN2 e o trasforma em número inteiro através do parseInt
        int s = n1 + n2;
        lblSoma.setText(Integer.toString(s));
        /*O comando setText funciona apenas com texto(string), ou seja,
        para pegarmos os valores das caixas anteriores precisamos pegar o texto dos labels e transformá-los em números.
        */
