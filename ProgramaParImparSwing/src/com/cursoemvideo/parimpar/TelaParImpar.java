...
public class TelaParImpar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnVerificar.setBackground(new java.awt.Color(153, 255, 204));
        ...
        txtResultado.setText("Aqui vai seu resultado:");
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        if (valor % 2 == 0) {
            txtResultado.setText("Seu valor é par");
        } else {
            txtResultado.setText("Seu valor é ímpar");
        }
